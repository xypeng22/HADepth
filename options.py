...
for i in range(1, 100):
    if not os.path.exists(os.path.join(os.path.dirname(__file__), "tmp", current_date + str(i).zfill(2))):
        log_dir = os.path.join(os.path.dirname(__file__), "tmp", current_date + str(i).zfill(2))
        break
